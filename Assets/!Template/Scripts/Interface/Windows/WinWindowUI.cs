...
public class WinWindowUI : WindowUI
{
    ...
    public void ClickNext ()
    {
        ...
        GameSessionManagerCCh.NextLevelData = new EndLevelData(GameEntryGameplayCCh.DragGameManager.Steps, GameEntryGameplayCCh.DragGameManager.AvilibleBoxes,
            GameEntryGameplayCCh.DragGameManager.UnlockBoxes, GameEntryGameplayCCh.DataContainer.MoneyContainer.Value);
        ClickRestart();
    }
}